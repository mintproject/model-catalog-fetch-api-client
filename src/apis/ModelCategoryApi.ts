...
export class ModelCategoryApi extends runtime.BaseAPI {
    ...
    */
    ...
    async modelcategorysIdDeleteRaw(requestParameters: ModelcategorysIdDeleteRequest): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling modelcategorysIdDelete.');
        }
        ...
        const response = await this.request({
            path: `/modelcategorys/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"user"}}`, encodeURIComponent(String(requestParameters.user))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    */
    ...
    async modelcategorysIdPutRaw(requestParameters: ModelcategorysIdPutRequest): Promise<runtime.ApiResponse<ModelCategory>> {
        ...
        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling modelcategorysIdPut.');
        }
    ...
    */
    ...
    async modelcategorysPostRaw(requestParameters: ModelcategorysPostRequest): Promise<runtime.ApiResponse<ModelCategory>> {
        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling modelcategorysPost.');
        }
        ...
        const response = await this.request({
            path: `/modelcategorys`.replace(`{${"user"}}`, encodeURIComponent(String(requestParameters.user))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ModelCategoryToJSON(requestParameters.modelCategory),
